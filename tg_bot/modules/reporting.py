...
# def __chat_settings_button__(chat_id, _):
#     if sql.chat_should_report(chat_id):
#         return [InlineKeyboardMarkup(
#                     [
#                         [
#                             InlineKeyboardButton(
#                                 text="Disable",
#                                 callback_data="toggle_rprts_0_({})".format(chat_id),
#                             )
#                         ]
#                     ]
#                 )]
...
#                             InlineKeyboardButton(
#                                 text="Enable",
#                                 callback_data="toggle_rprts_1_({})".format(chat_id),
#                             )
#                         ]
#                     ]
#                 )]
